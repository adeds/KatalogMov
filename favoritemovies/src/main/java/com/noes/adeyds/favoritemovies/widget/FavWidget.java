...
public class FavWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.noes.adeyds.favoritemovies.TOAST";
    public static final String EXTRA_ITEM = "com.noes.adeyds.favoritemovies.EXTRA";
